...
class AippmStudy extends StatefulWidget {
  const AippmStudy({Key? key}) : super(key: key);

  @override
  State<AippmStudy> createState() => _AippmStudyState();
}

class _AippmStudyState extends State<AippmStudy> {
  @override
