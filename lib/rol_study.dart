...
class RolStudy extends StatefulWidget {
  const RolStudy({Key? key}) : super(key: key);

  @override
  State<RolStudy> createState() => _RolStudyState();
}

class _RolStudyState extends State<RolStudy> {
  @override
